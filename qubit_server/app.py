...
# from quantum_logic import get_bloch_animation, get_circuit_images 
...
#         ideal_sim,transpiled_sim = get_circuit_images(gates,target_backend_key)
...
#         data = request.json
#         gates = data.get('gates',[])
#         gif_b64 = get_bloch_animation(gates)
#         return jsonify({
#             'player_id':data.get('player_id'),
#             'gif': gif_b64,
#         })
